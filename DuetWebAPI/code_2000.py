...
"""
To calibrate the load cell data with MTS data (for 2000 N load)
"""

loadcell_data = openpyxl.load_workbook(
    "DuetWebAPI/calibration_data/loadcell_data_time_2000_1.xlsx")
dataframe_lc = loadcell_data.active
mts_data = openpyxl.load_workbook(
    "DuetWebAPI/calibration_data/data_MTS_2000_1.xlsx")
dataframe_mts = mts_data.active

loadcell_data_2 = openpyxl.load_workbook(
    "DuetWebAPI/calibration_data/loadcell_data_time_2000_2.xlsx")
dataframe_lc_2 = loadcell_data_2.active
mts_data_2 = openpyxl.load_workbook(
    "DuetWebAPI/calibration_data/data_MTS_2000_2.xlsx")
dataframe_mts_2 = mts_data_2.active

loadcell_data_3 = openpyxl.load_workbook(
    "DuetWebAPI/calibration_data/loadcell_data_time_2000_3.xlsx")
dataframe_lc_3 = loadcell_data_3.active
mts_data_3 = openpyxl.load_workbook(
    "DuetWebAPI/calibration_data/data_MTS_2000_3.xlsx")
